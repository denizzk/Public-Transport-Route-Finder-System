...
public class StartLocationRecyclerViewAdapter extends RecyclerView
        .Adapter<StartLocationRecyclerViewAdapter.ViewHolder> {
    ...
    public StartLocationRecyclerViewAdapter() {
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int
        ...
        editor.putFloat("start_lat", mCoordinates.get(position).lat);
        editor.putFloat("start_lng", mCoordinates.get(position).lng);
        editor.apply();
