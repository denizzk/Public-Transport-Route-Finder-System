...
public class TabAddRouteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        View view = inflater.inflate(R.layout.fragment_add_route_tab, container, false);
            ...
            public void onClick(View v) {
                if (!editRouteName.getText().toString().equals("") && !editRouteId.getText()
                    ...
                    Toast.makeText(getContext(), editRouteId.getText().toString() + " " +
                            editRouteName
                                    .getText()
                                    .toString() + " route successfully added!", Toast
                            .LENGTH_SHORT).show();
                } else
