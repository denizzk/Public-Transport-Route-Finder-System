...
public class TabEditStopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        View view = inflater.inflate(R.layout.fragment_edit_stop_tab, container, false);
        ...
        btnEditStop = view.findViewById(R.id.btn_edit_stop);
            ...
            public void onClick(View v) {
                if (!editStopName.getText().toString().equals("") && !editStopId.getText()
                    ...
                    Toast.makeText(getContext(), editStopId.getText().toString() + " " +
                            editStopName
                                    .getText()
                                    .toString() + " stop successfully updated!", Toast
                            .LENGTH_SHORT).show();
                } else
